...
function Layout({ children }) {
    ...
    return (
        ...
        <div className={styles.container}>
            ...
            <div>
                <BannerLeft carpeta="BannerIzquierdo" items={[1, 2, 3, 4]} click={handlerClickEnlace}></BannerLeft>
            </div>
            <div>
                <BannerRight carpeta="BannerDerecho" items={[1, 2, 3, 4]} click={handlerClickEnlace}></BannerRight>
            </div>
